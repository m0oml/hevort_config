...
M566 X900 Y900 Z12 E3600                                ; Jerk (mm/min)
M203 X30000 Y30000 Z1000 E6000                          ; Max speeds (mm/min)
M201 X35000 Y35000 Z20 E2000                            ; Accelerations (mm/s^2)
...
; Probe trigger height, mm - THE one place it is set. G31 below, mesh.g and
...
if !exists(global.trigZ)
    global trigZ = -0.174                                   ; 26/09/2026: -0.264 -> -0.234 -> -0.204 -> -0.174 in three 0.03 steps; the old stored map had been pulling the nozzle low, per-print mesh removed that
...
M143 H0 P1 T2 S180 A2                                   ; Bed mat SOFT limit 180C on S2: A2 clamps PWM to 0 while above, self-recovering, no fault
M143 H0 P2 T2 S205 A0                                   ; Bed mat HARD limit 205C on S2: A0 latches a heater fault, clear with M562 P0
M307 H0 R0.033 K0.028 E1.0 D45 B0                       ; Bed PID model
M570 H0 P600 T15                                        ; Bed heater fault detection
